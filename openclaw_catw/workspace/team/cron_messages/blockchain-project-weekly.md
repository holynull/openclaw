...
- 调用fetch_rss_news工具（类似feishu_doc的调用方式）：
  - sources: ["https://blog.ethereum.org/feed.xml", "https://blog.chain.link/rss/", "https://polygon.technology/blog/feed/", "https://www.alchemy.com/blog/rss.xml", "https://blog.celestia.org/rss/"]
  - maxItemsPerSource: 2
...
6. **生成后立即写入临时文件**：调用write工具，路径为 `/tmp/blockchain-project-weekly-report.md`
...
1. 调用read工具，读取 `/tmp/blockchain-project-weekly-report.md` 文件内容

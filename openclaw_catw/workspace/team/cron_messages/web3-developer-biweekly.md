...
- 调用fetch_rss_news工具（类似feishu_doc的调用方式）：
  - sources: ["https://ethresear.ch/latest.rss", "https://blog.logrocket.com/tag/web3/feed/", "https://hackernoon.com/feed", "https://moralis.io/blog/feed/", "https://www.quicknode.com/blog/rss.xml"]
  - maxItemsPerSource: 2
...
6. **生成后立即写入临时文件**：调用write工具，路径为 `/tmp/web3-developer-biweekly-report.md`
...
1. 调用read工具，读取 `/tmp/web3-developer-biweekly-report.md` 文件内容

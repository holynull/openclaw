...
- 调用fetch_rss_news工具（类似feishu_doc的调用方式）：
  - sources: ["https://blog.synthetix.io/rss/", "https://dappradar.com/blog/feed", "https://web3wire.org/feed/gn", "https://decrypt.co/feed", "https://blockworks.co/feed/"]
  - maxItemsPerSource: 2
...
6. **生成后立即写入临时文件**：调用write工具，路径为 `/tmp/defi-ecosystem-weekly-report.md`
...
1. 调用read工具，读取 `/tmp/defi-ecosystem-weekly-report.md` 文件内容

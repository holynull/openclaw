...
- 调用fetch_rss_news工具（类似feishu_doc的调用方式）：
  - sources: ["https://bitcoinops.org/feed.xml", "https://blog.blockstream.com/rss/", "https://www.lynalden.com/feed/", "https://blog.keys.casa/rss/"]
  - maxItemsPerSource: 2
...
6. **生成后立即写入临时文件**：调用write工具，路径为 `/tmp/bitcoin-tech-monthly-report.md`
...
🔧 **协议升级**：{提取1-2个重要协议/BIP更新}
💻 **Core开发**：{如有Bitcoin Core开发相关概括}
📊 **网络状态**：{网络健康/安全关键信息}
🆕 **技术创新**：{如有新技术/方案标注}
...
1. 调用read工具，读取 `/tmp/bitcoin-tech-monthly-report.md` 文件内容
